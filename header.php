...
<header style="background: url('http://og1m0yoqf.bkt.clouddn.com/relax/img/header.jpg') center 0px repeat-x;background-size: cover;" id="header" class="header">
<div class="container-inner">
 <div class="relax-logo">
	...
	<div id="nav-header" class="navbar">
		<ul class="nav">
			<?php echo str_replace("</ul></div>", "", ereg_replace("<div[^>]*><ul[^>]*>", "", wp_nav_menu(array('theme_location' => 'primary', 'depth' => 2,'echo' => false)) )); ?>
